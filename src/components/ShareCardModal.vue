    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">土味情话与告白</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 土味情话与高情商告白助手</span>
...
// 清理回复末尾的特殊标记 [TUWEI_SCORES]...[/TUWEI_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[TUWEI_SCORES\][\s\S]*?\[\/TUWEI_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 土味情话与高情商告白】\n\n${cleanContent.value}\n\n体验心动告白AI助手：https://ai.wuxian.xyz`;
